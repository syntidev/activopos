...
export function CargoModal({ open, onClose, currentPct, totalUsd, onApply }: CargoModalProps) {
    ...
    <Modal
      ...
      footer={
        <div className={styles.footer}>
          {currentPct > 0 && (
            <Button variant="danger" onClick={handleRemove}>Quitar cargo</Button>
          )}
      ...
      <div className={styles.body}>
        ...
        <div className={styles.inputWrapper}>
          ...
          <input
            ...
            step="0.01"
            autoFocus
            aria-label={type === 'pct' ? 'Porcentaje de cargo' : 'Monto del cargo en USD'}
          />
        </div>
