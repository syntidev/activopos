...
const productSchema = z.object({
  ...
  cost_unknown:       z.boolean().default(false),
  ...
  try {
    ...
    const product = await db.product.create({
      data: {
        ...
        cost_per_unit_usd:  data.cost_unknown ? null : (data.cost_per_unit_usd ?? null),
        cost_unknown:       data.cost_unknown,
        price_per_unit_usd: calcPrice(data.cost_unknown ? null : data.cost_per_unit_usd, margin, data.price_per_unit_usd),
