...
export const PLANS: Plan[] = [
  { name: 'Gratis', priceUsd: 0, shortDescription: 'gratis para siempre sin tarjeta de crédito: POS táctil, tasa BCV automática, Pago Móvil/Zelle/efectivo/USDT, código de barras por cámara, hasta 40 productos, 1 usuario.', fullDescription: 'gratis de forma permanente y sin tarjeta de crédito: POS táctil en cualquier pantalla, tasa BCV automática en cada venta, pagos por Pago Móvil, Zelle, efectivo o USDT, lector de código de barras con la cámara del móvil, hasta 40 productos y 1 usuario.' },
  { name: 'Negocio Activo', priceUsd: 19, shortDescription: 'todo lo del plan Gratis sin límites, catálogo digital, finanzas completas, hasta 10 usuarios y productos ilimitados. Cuatro ciclos: mensual 19 USD, trimestral 16.67 USD/mes, semestral 15.00 USD/mes, anual 13.00 USD/mes.', fullDescription: 'todo lo del plan Gratis sin límites, más catálogo digital público con checkout por WhatsApp, multi-ticket, pago mixto y venta a crédito, finanzas completas (cuentas por cobrar y por pagar, gastos, punto de equilibrio, P&L), hasta 10 usuarios y productos ilimitados, importación de productos por Excel, pedidos con Kanban y notificación por WhatsApp, clientes y cuentas por cobrar, proveedores y compras, reportes exportables en Excel y PDF, 10 temas visuales por segmento de negocio, variantes de productos, cotizaciones y crédito. Cuatro ciclos de facturación: mensual a 19.00 USD por mes, trimestral a 50.00 USD cada 3 meses (equivale a 16.67 USD por mes, 12% de ahorro), semestral a 90.00 USD cada 6 meses (equivale a 15.00 USD por mes, 21% de ahorro) y anual a 156.00 USD por año (equivale a 13.00 USD por mes, 32% de ahorro). El precio en bolívares se calcula en tiempo real a la tasa paralela del dólar. Sin contratos, sin costos ocultos, cancela cuando quieras.' },
]
