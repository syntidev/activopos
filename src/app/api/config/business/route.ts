...
const PatchSchema = z.object({
  ...
  catalog_default_currency: z.enum(['usd', 'bs', 'both']).optional(),
  catalog_title:     z.string().max(150).nullable().optional(),
  catalog_desc:      z.string().max(2000).nullable().optional(),
  catalog_desc_enabled: z.boolean().optional(),
