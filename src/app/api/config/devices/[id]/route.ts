...
export async function PATCH(
  ...
  try {
    ...
    const existing = await db.businessDevice.findFirst({
    ...
    const device = await db.businessDevice.update({
      where: { id }, // business_id inyectado por el tenant layer
      data: {
...
export async function DELETE(
  ...
  try {
    ...
    await db.businessDevice.delete({ where: { id } }) // business_id inyectado por el tenant layer
